        ...
        <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-[#0B2A4A] to-[#1e3a5f] text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-xl bg-white bg-opacity-20">
                {member.fullName ? member.fullName.charAt(0).toUpperCase() : 'M'}
              </div>
              <div>
                <h2 className="text-xl font-bold">Edit Team Member</h2>
                <p className="text-blue-100">Update {member.fullName}'s information</p>
              </div>
            </div>
            <button
      ...
      <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#0B2A4A] focus:border-transparent ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#0B2A4A] focus:border-transparent ${
        ...
        <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
          ...
          <button
            ...
            className="px-6 py-2 bg-[#0B2A4A] text-white rounded-lg hover:bg-[#0d2d4f] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
