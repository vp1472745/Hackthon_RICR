                ...
                {currentStep === 2 && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <button
                        onClick={() => {
                          setSelectedPayment(prev => ({ ...prev, action: 'approve' }));
                          setCurrentStep(3);
                        }}
                        className="p-4 border-2 border-green-200 rounded-lg hover:border-green-400 hover:bg-green-50 transition-colors text-left"
                      >
                        <div className="text-green-600 font-semibold">Approve Payment</div>
                        <div className="text-green-500 text-sm mt-1">Mark this payment as verified and approved</div>
                      </button>

                      <button
                        onClick={() => {
                          setSelectedPayment(prev => ({ ...prev, action: 'reject' }));
                          setCurrentStep(3);
                        }}
                        className="p-4 border-2 border-red-200 rounded-lg hover:border-red-400 hover:bg-red-50 transition-colors text-left"
                      >
                        <div className="text-red-600 font-semibold">Reject Payment</div>
                        <div className="text-red-500 text-sm mt-1">Payment requires correction or is invalid</div>
                      </button>
                    </div>
                  ...
                  <div className="space-y-6">
                    {selectedPayment.action === 'reject' ? (
                      ...
                      <div className="text-center space-y-4">
                        ...
                        <div>
                          <h4 className="text-lg font-medium text-gray-900">Approve Payment?</h4>
